...
Tema: [nombre del plan o area, ej: correcciones-middleware]
DIR_DESTINO: [ruta opcional]
...
Redactar el informe completo y guardarlo en `[DIR_PYT]/out-plan-[tema]-[YYYY-MM-DD].md`.

El tema se obtiene del campo `Tema:` en la invocación. Si no se especifico, se deduce del nombre del directorio del plan activo (ej: `01-middleware`).
...
**DIR_PYT:** [ruta]
**Tema:** [tema]
**Informe:** [DIR_PYT]/out-plan-[tema]-[YYYY-MM-DD].md
