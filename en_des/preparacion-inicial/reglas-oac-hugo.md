...
4. **Arquitectura Usuario ↔ OAC ↔ Hugo**. El usuario interactúa con OAC; OAC (mediante OCC) gestiona todo el trabajo con Hugo. No ejecutar comandos de Hugo directamente.
